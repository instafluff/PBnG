...
(function (window){
    ...
    MarchingSquaresOld.walkPerimeter = function(startX, startY){
        ...
        MarchingSquaresOld.curPixel = MarchingSquaresOld.sourceContext.getImageData(x, y, 1, 1).data;
    ...
    MarchingSquaresOld.step = function(x, y){
        ...
        // console.log( MarchingSquaresOld.sampleData );

        MarchingSquaresOld.upLeft = ( MarchingSquaresOld.sampleData[0] == MarchingSquaresOld.curPixel[ 0 ] ) &&
                                    ( MarchingSquaresOld.sampleData[1] == MarchingSquaresOld.curPixel[ 1 ] ) &&
                                    ( MarchingSquaresOld.sampleData[2] == MarchingSquaresOld.curPixel[ 2 ] );
        MarchingSquaresOld.upRight = ( MarchingSquaresOld.sampleData[4] == MarchingSquaresOld.curPixel[ 0 ] ) &&
                                    ( MarchingSquaresOld.sampleData[5] == MarchingSquaresOld.curPixel[ 1 ] ) &&
                                    ( MarchingSquaresOld.sampleData[6] == MarchingSquaresOld.curPixel[ 2 ] );
        MarchingSquaresOld.downLeft = ( MarchingSquaresOld.sampleData[8] == MarchingSquaresOld.curPixel[ 0 ] ) &&
                                    ( MarchingSquaresOld.sampleData[9] == MarchingSquaresOld.curPixel[ 1 ] ) &&
                                    ( MarchingSquaresOld.sampleData[10] == MarchingSquaresOld.curPixel[ 2 ] );
        MarchingSquaresOld.downRight = ( MarchingSquaresOld.sampleData[12] == MarchingSquaresOld.curPixel[ 0 ] ) &&
                                    ( MarchingSquaresOld.sampleData[13] == MarchingSquaresOld.curPixel[ 1 ] ) &&
                                    ( MarchingSquaresOld.sampleData[14] == MarchingSquaresOld.curPixel[ 2 ] );
