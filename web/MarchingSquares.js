...
(function (window){
    ...
    MarchingSquares.walkPerimeter = function(startX, startY){
        ...
        MarchingSquares.curPixel = [ imageData.data[startY * imageData.width * 4 + startX * 4 + 0],
                                     imageData.data[startY * imageData.width * 4 + startX * 4 + 1],
                                     imageData.data[startY * imageData.width * 4 + startX * 4 + 2] ];
    ...
    MarchingSquares.step = function(index, data, width4){
        ...
        MarchingSquares.upLeft = ( data[index + 0] == MarchingSquares.curPixel[ 0 ] ) &&
                                 ( data[index + 1] == MarchingSquares.curPixel[ 1 ] ) &&
                                 ( data[index + 2] == MarchingSquares.curPixel[ 2 ] );
        MarchingSquares.upRight = ( data[index + 4] == MarchingSquares.curPixel[ 0 ] ) &&
                                 ( data[index + 5] == MarchingSquares.curPixel[ 1 ] ) &&
                                 ( data[index + 6] == MarchingSquares.curPixel[ 2 ] );
        MarchingSquares.downLeft = ( data[index + width4 + 0] == MarchingSquares.curPixel[ 0 ] ) &&
                                 ( data[index + width4 + 1] == MarchingSquares.curPixel[ 1 ] ) &&
                                 ( data[index + width4 + 2] == MarchingSquares.curPixel[ 2 ] );
        MarchingSquares.downRight = ( data[index + width4 + 4] == MarchingSquares.curPixel[ 0 ] ) &&
                                 ( data[index + width4 + 5] == MarchingSquares.curPixel[ 1 ] ) &&
                                 ( data[index + width4 + 6] == MarchingSquares.curPixel[ 2 ] );
